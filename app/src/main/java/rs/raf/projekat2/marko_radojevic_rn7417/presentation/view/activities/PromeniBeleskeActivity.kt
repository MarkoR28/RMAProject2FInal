...
class PromeniBeleskeActivity : AppCompatActivity(R.layout.activity_promeni_beleske) {
    ...
    private lateinit var dateOfCreate : Date
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (beleska != null) {
            ...
            dateOfCreate=beleska.dateOfCreate
    ...
    private fun initListener(){
        ...
        izmeniBtn.setOnClickListener {
            beleskeViewModel.updateByIdBeleska(
                BeleskaEntity(id,noviNazivTxt.text.toString(),noviZapisTxt.text.toString(),arhiva,dateOfCreate)
            )
            finish()
