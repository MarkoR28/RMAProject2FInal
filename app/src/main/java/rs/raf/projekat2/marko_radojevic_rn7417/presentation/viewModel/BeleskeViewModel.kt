...
class BeleskeViewModel(private val beleskeRepository: BeleskeRepository) : ViewModel(), BeleskaContract.ViewModel {
    ...
    val statistika : MutableLiveData<List<BeleskaEntity>> = MutableLiveData()
    private val beleskaList :MutableList<BeleskaEntity> = mutableListOf()
    val statistikaList :MutableList<BeleskaEntity> = mutableListOf()
    ...
    override fun getListStatistika() : LiveData<List<BeleskaEntity>>{
        return statistika
    }
